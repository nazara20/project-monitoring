              ...
              <div class="col-lg-7 mx-auto">
                ...
                <form action="<?= base_url('monitoring/create') ?>" method="post">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input class="form-control" type="number" value="0" id="progress" name="progress" min="0" max="100" maxlength="3"
                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); changeHandler(this)">
